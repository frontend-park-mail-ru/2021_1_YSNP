...
export class Settings {
    ...
    addListeners() {
        document
            .getElementById('profile-right-part')
    ...
    __getTemplate() {
        return `
        <div class="profile-right-part" id="profile-right-part">
            <div class="settings-user-data">
                <div class="settings-data-title">
                    <span>Личные данные</span>
                    <span class="settings-data-edit" id="settings-edit" data-action="editClick">
                    ...
                    <button id="settings-button-save" class="settings_data_save_button" data-action="saveChangesClick">Сохранить изменения</button>
                </div>
                <div class="settings-right__separator"></div>
                <div class="settings-data-components">
                    <div class="settings-data-right-components">
                        <span class="settings-data-component-title">Фамилия</span>
                        <span class="settings-data-component-title">Имя</span>
                        <span class="settings-data-component-title">Отчество</span>
                        <span class="settings-data-component-title">Пол</span>
                        <span class="settings-data-component-title">Дата рождения</span>
                        <span class="settings-data-component-title">Телефон</span>
                        <span class="settings-data-component-title">Город</span>
                        <span class="settings-data-component-title">E-mail</span>
                        <span id="settings-photo-label" class="settings-data-component-title settings-photo-label">Фото</span>
                    </div>
                    <div class="settings-data-left-components">
                        <input id="settings-input-surname" required class="settings-data-input" type="text" value="${this.__data.surname}" readonly>
                        <input id="settings-input-name" required class="settings-data-input" type="text" value="${this.__data.name}" readonly>
                        <input id="settings-input-patronymic" class="settings-data-input" type="text" value="${this.__data.patronymic}" readonly>                             
                        <select id="settings-input-gender" class="settings-data-input" disabled>
                            <option value=”woman”>Женский</option>
                            <option value=”man”>Мужской</option>
                        </select>                               
                        <input id="settings-input-birthday" class="settings-data-input" type="date" min="1900-01-01" max="2021-01-01" value="${this.__data.birthday}" readonly>                             
                        <input id="settings-input-telephone" class="settings-data-input" type="tel" value="${this.__data.telephone}" readonly>                             
                        <input id="settings-input-location" class="settings-data-input" type="text" value="${this.__data.location}" readonly>                             
                        <input id="settings-input-email" required class="settings-data-input" type="email" value="${this.__data.email}" readonly>     
                        <input style="visibility: hidden" id="settings-file-upload" data-action="uploadFileClick" class="settings-data-input" type="file" accept="image/*"/>
                    </div>
                
    <!--            <div class="settings-data-add-account">-->
    <!--                <span class="settings-data-component-title">Привязать аккаунт</span>-->
    <!--                <a class="settings-data-icon">-->
    ...
    <!--            <div class="settings-data-title">Общие настройки</div>-->
    <!--            <div class="settings-right__separator"></div>-->
    <!--            <a href="#" class="settings-settings-content-item">-->
