                ...
                <div class="settings-photo-inner">
                    ...
                    <div class="settings-input-inner">
                        ...
                        <div class="settings-avatar">
                             <div class="circle" id="settings-avatar" data-action="clickUpload">
                                 <img class="profile-pic" id="settings-profile-pic" src="${this.__data.avatar}" alt="img">                            
                                 <div class="p-image">
                                       <i class="settings-upload-button" id="settings-upload-button">
