            ...
            <div class="info-card">
                ...
                <div class="info-card--profile">
                    ...
                    <div class="info-card--profile--container">
                        <p class="info-card--profile--container__name">${this.__getName}</p>
                ...
                <div class="info-card--statistic">
                    <div class="info-card--statistic-inner-views">
                        ...
                        <span class="info-card--statistic-inner-views__views">${this.__getViews}</span>
                    </div>
                     <div class="info-card--statistic-inner-likes">            
                        ...
                        <span class="info-card--statistic-inner-likes__likes">${this.__getLikes}</span>
                    </div>
                </div>
            </div>
        `;
