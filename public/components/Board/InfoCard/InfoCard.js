...
export class InfoCard {
    ...
    __getTemplate() {
        return `     
            <div class="info-card">
                <p class="info-card__price">3 990 000 ₽</p>
